...
- Полное отображение изображений котиков на экране детальной информации без обрезки, с возможностью масштабирования.
- Список лайкнутых котиков при нажатии на количество лайков с фильтром по породе и возможностью удаления.
